                ...
                <div class="col">
                    ...
                    <select class="form-control" name="estado_civil">
                        <option value="{{ $empleado->estado_civil }}" selected disabled
                            {{ old('estado_civil') == 'seleccionado' ? 'selected' : '' }}>{{ $empleado->estado_civil }}
                        <option value="Soltero(a)" {{ $empleado->estado_civil == 'Soltero(a)' ? 'selected' : '' }}>
                            Soltero(a)</option>
                        <option value="Casado(a)" {{ $empleado->estado_civil == 'Casado(a)' ? 'selected' : '' }}>Casado(a)
                        </option>
                        <option value="Divorciado(a)" {{ $empleado->estado_civil == 'Divorciado(a)' ? 'selected' : '' }}>
                            Divorciado(a)</option>
                ...
                <div class="col">
                    ...
                    <select class="form-control" name="tipo_contrato">
                        <option value="{{ $empleado->tipo_contrato }}" selected disabled
                            {{ old('tipo_contrato') == 'seleccionado' ? 'selected' : '' }}>{{ $empleado->tipo_contrato }}
                        <option value="tiempo completo"
                            {{ $empleado->tipo_contrato == 'tiempo completo' ? 'selected' : '' }}>Tiempo completo</option>
                        <option value="medio tiempo" {{ $empleado->tipo_contrato == 'medio tiempo' ? 'selected' : '' }}>
                            Medio tiempo</option>
                        <option value="temporal" {{ $empleado->tipo_contrato == 'temporal' ? 'selected' : '' }}>Temporal
                        </option>
                    </select>
                </div>
            </div>
